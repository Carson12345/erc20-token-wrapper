...
const TokenAContract = require("../build/contracts/TokenA.json");
const TokenBContract = require("../build/contracts/TokenB.json");
...
const init = async () => {
    ...
    const provider = new HDWalletProvider(privateKey, `https://ropsten.infura.io/v3/${secrets.projectId}`);
